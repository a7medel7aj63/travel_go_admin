...
class MuseumController extends GetxController {
  ...
  void onInit() {
    ...
    collectionReference = firebaseFirestore.collection("museum");
    name = TextEditingController();
    location = TextEditingController();
    about = TextEditingController();
    muse.bindStream(getAllMuse());
    loading.value = true;
    super.onInit();
  }

  Stream<List<Mueseum>> getAllMuse() => collectionReference
      .snapshots()
  ...
  void addMuse(BuildContext context) {
                  ...
                  if (imagePage.image.isNotEmpty) {
                    ...
                    try {
                      ...
                      await collectionReference
                        ...
                        showbar('title', 'subtitle', 'Museum Added', true);
                        update();
                      });
                    } catch (e) {
                      Get.back();
  ...
  void editMuseum(String id, BuildContext context, String name1,
              ...
              onPressed: () async {
                try {
                  ...
                  await collectionReference
                    ...
                    Get.back();
                    Get.back();
                    showbar('title', 'subtitle', 'Museum Edited', true);
                    update();
                  });
                } catch (e) {
                  Get.back();
  ...
  void deleteMuseum(String id) {
    Get.dialog(AlertDialog(
      content: const Text('Museum delete'),
      actions: [
        TextButton(
            onPressed: () async {
              try {
                ...
                Get.back();
                Get.back();
                showbar('Delete Museum', '', 'Museum Deleted', true);
              } catch (e) {
                showbar('Delete Museum ', '', e.toString(), false);
                Get.back();
              }
            },

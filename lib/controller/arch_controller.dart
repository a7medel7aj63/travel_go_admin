...
class ArchController extends GetxController {
  ...
  void onInit() {
    ...
    collectionReference = firebaseFirestore.collection("Arch");
    name = TextEditingController();
    location = TextEditingController();
    about = TextEditingController();
    archs.bindStream(getAllArchs());
    loading.value = true;
    super.onInit();
  }

  Stream<List<Arch>> getAllArchs() => collectionReference
      .snapshots()
  ...
  void addArch(BuildContext context) {
                  ...
                  if (imagePage.image.isNotEmpty) {
                    ...
                    try {
                      ...
                      await collectionReference
                        ...
                        showbar('title', 'subtitle', 'Arch Added', true);
                        update();
                      });
                    } catch (e) {
                      Get.back();
  ...
  void editArch(String id, BuildContext context, String name1, String location1,
      String about1) {
    final GlobalKey<FormState> formKey = GlobalKey<FormState>();
    final data = MediaQuery.of(context);
    name.text = name1;
              ...
              onPressed: () async {
                try {
                  ...
                  await collectionReference
                    ...
                    Get.back();
                    Get.back();
                    showbar('title', 'subtitle', 'Arch Edited', true);
                    update();
                  });
                } catch (e) {
                  Get.back();
  ...
  void deleteArch(String id) {
    Get.dialog(AlertDialog(
      content: const Text('Arch delete'),
      actions: [
        TextButton(
            onPressed: () async {
              try {
                ...
                Get.back();
                Get.back();
                showbar('Delete Arch', '', 'Arch Deleted', true);
              } catch (e) {
                showbar('Delete Arch ', '', e.toString(), false);
                Get.back();
              }
            },

...
class BankController extends GetxController {
  ...
  void onInit() {
    ...
    collectionReference = firebaseFirestore.collection("bank");
    name = TextEditingController();
    location = TextEditingController();
    about = TextEditingController();
    banks.bindStream(getAllBanks());
    loading.value = true;
    super.onInit();
  }

  Stream<List<Bank>> getAllBanks() => collectionReference
      .snapshots()
  ...
  void addBank(BuildContext context) {
                  ...
                  if (imagePage.image.isNotEmpty) {
                    ...
                    try {
                      ...
                      await collectionReference
                        ...
                        showbar('title', 'subtitle', 'Bank Added', true);
                        update();
                      });
                    } catch (e) {
                      Get.back();
  ...
  void editBank(String id, BuildContext context, String name1, String location1,
      String about1) {
    final GlobalKey<FormState> formKey = GlobalKey<FormState>();
    final data = MediaQuery.of(context);
    name.text = name1;
              ...
              onPressed: () async {
                try {
                  ...
                  await collectionReference
                    ...
                    Get.back();
                    Get.back();
                    showbar('title', 'subtitle', 'Bank Edited', true);
                    update();
                  });
                } catch (e) {
                  Get.back();
  ...
  void deleteBank(String id) {
    Get.dialog(AlertDialog(
      content: const Text('Bank delete'),
      actions: [
        TextButton(
            onPressed: () async {
              try {
                ...
                Get.back();
                Get.back();
                showbar('Delete Bank', '', 'Bank Deleted', true);
              } catch (e) {
                showbar('Delete Bank ', '', e.toString(), false);
                Get.back();
              }
            },

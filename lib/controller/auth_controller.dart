...
import 'package:travel_go/screens/login_page.dart';
import 'package:travel_go/widgets/loading.dart';
import 'package:travel_go/widgets/snackbar.dart';
...
class AuthController extends GetxController {
  ...
  void register() async {
    if (name.text.isNotEmpty &&
      ...
      if (password.text == repassword.text) {
        ...
        showbar("About User", "User message", 'Password Not Matched', false);
      }
    } else {
      showbar("About User", "User message", 'Please Enter All Fields', false);
    }
  }
  ...
  void login() async {
    if (email.text.isNotEmpty && password.text.isNotEmpty) {
      ...
      showbar("About Login", "Login message", 'Please Enter All Fields', false);
    }
  }
}
